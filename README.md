...
=================
[![Supported PHP Versions](https://img.shields.io/badge/PHP-7.4,%208.0,%208.1,%208.2-blue)](https://github.com/Athlon1600/php-curl-file-downloader)
...
| 2.x.x | EOL | [v2.3.3] | >= 7.4 |
| 2.3.2 | OK | [v2.3.2] | 5.6 - 8.1.* |
